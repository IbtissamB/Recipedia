...
SECRET_KEY = 'django-insecure-88qj(6p75v9g=4cb1tk93yo&d!=e&jeq5mv9o!n@#%o(+@p^r+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['IbtissamB.pythonanywhere.com', 'localhost', '127.0.0.1']
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'rest_framework.authentication.SessionAuthentication', # Keep this for the browsable API
    ),
